...
class Pong:
    ...
    def disegna_scritte_giocatore_singolo(self,schermata):
        ...
        rect_testo_giocatore_singolo = testo_font_giocatore_singolo.get_rect(center=(self.LARGHEZZA//2,20))
        rect_punteggio_giocatore_1 = testo_font_punteggio_giocatore_1.get_rect(center=(self.LARGHEZZA//2-80,75))
        rect_punteggio_giocatore_2 = testo_font_punteggio_giocatore_2.get_rect(center=(self.LARGHEZZA//2+80,75))
        ...
        schermata.blit(testo_font_giocatore_singolo,rect_testo_giocatore_singolo)
        schermata.blit(testo_font_punteggio_giocatore_1,rect_punteggio_giocatore_1)
        schermata.blit(testo_font_punteggio_giocatore_2,rect_punteggio_giocatore_2)
    ...
    def schermata_pre_gioco(self,schermata):
        ...
        rect_testo_1 = surf_testo_1.get_rect(center=(self.LARGHEZZA_surf//2,35))
        rect_testo_2 = surf_testo_2.get_rect(center=(self.LARGHEZZA_surf//2,58))
        rect_testo_giocatore_singolo = surf_testo_giocatore_singolo.get_rect(center=(self.LARGHEZZA_surf//2,110))
        rect_testo_multigiocatore = surf_testo_multigiocatore.get_rect(center=(self.LARGHEZZA_surf//2,370))
        surf.blit(surf_testo_1,rect_testo_1)
        surf.blit(surf_testo_2,rect_testo_2)
        surf.blit(surf_testo_giocatore_singolo,rect_testo_giocatore_singolo)
        surf.blit(surf_testo_multigiocatore,rect_testo_multigiocatore)
    ...
    def disegna_scritte_multigiocatore(self,schermata):
        ...
        testo_font_punteggio_giocatore_1 = font_punteggio_giocatore_1.render(str(self.get_punteggio_giocatore_1()),True,ROSSO)
        testo_font_punteggio_giocatore_2 = font_punteggio_giocatore_2.render(str(self.get_punteggio_giocatore_2()),True,ROSSO)
        rect_testo_multigiocatore = testo_font_multigiocatore.get_rect(center=(self.LARGHEZZA//2,20))
        rect_punteggio_giocatore_1 = testo_font_punteggio_giocatore_1.get_rect(center=(self.LARGHEZZA//2-80,75))
        rect_punteggio_giocatore_2 = testo_font_punteggio_giocatore_2.get_rect(center=(self.LARGHEZZA//2+80,75))
        pygame.draw.line(schermata,NERO,(self.get_x_racchetta_1()+self.LARGHEZZA_racchetta//2,0),(self.get_x_racchetta_1()+self.LARGHEZZA_racchetta//2,self.ALTEZZA),1)
        pygame.draw.line(schermata,NERO,(self.LARGHEZZA//2,0),(self.LARGHEZZA//2,self.ALTEZZA),1)
        ...
        schermata.blit(testo_font_multigiocatore,rect_testo_multigiocatore)
        schermata.blit(testo_font_punteggio_giocatore_1,rect_punteggio_giocatore_1)
        schermata.blit(testo_font_punteggio_giocatore_2,rect_punteggio_giocatore_2)
        pygame.draw.rect(schermata,ROSSO,(430,55,40,10),0)
        return testo_font_punteggio_giocatore_1,testo_font_punteggio_giocatore_2
